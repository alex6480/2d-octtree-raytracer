...
import PixelQuadtree, { PixelQuadTreeNode } from "./PixelQuadTree";
...
export default class Ray {
    ...
    public intersectQuadTree(tree: PixelQuadtree, maxDepth?: number): number | null {
        ...
        do {
            ...
            // Check for hit
            if (currentNode.quadNode.solid && (stack.length === maxDepth || ! currentNode.quadNode.isDivided)) {
                // We have a hit.
